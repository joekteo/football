...
(function() {
  $(function() {
    var aboutTemplate, afterLoginTemplate, beforeLoginTemplate, contactTemplate, helpTemplate, leaderboardTemplate, loginNav, main, newEventTemplate, pastGames, privacyTemplate, profileTemplate, resultsTemplate, setActive, termsTemplate, unsetActive, upcomingGames, upcomingTemplate;
    upcomingGames = [
      {
        homeTeam: "Brazil",
        awayTeam: "Argentina",
