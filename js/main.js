...
(function() {
  $(function() {
    var aboutTemplate, afterLoginTemplate, beforeLoginTemplate, contactTemplate, dashboardTemplate, helpTemplate, leaderboardTemplate, loginNav, main, pastGames, playersByPercent, playersByUnit, privacyTemplate, profileTemplate, setActive, termsTemplate, unsetActive, upcomingGames;
    upcomingGames = [
      {
        homeTeam: "Brazil",
        awayTeam: "Argentina",
