...
(function() {
  $(function() {
    var aboutTemplate, afterLoginTemplate, beforeLoginTemplate, contactTemplate, dashboardTemplate, helpTemplate, leaderboardTemplate, loginNav, main, pastGames, playersByPercent, playersByUnit, privacyTemplate, profileTemplate, setActive, showGames, showPastGames, showUpcomingGames, termsTemplate, unsetActive, upcomingGames;
    upcomingGames = [
      {
        homeTeam: "Brazil",
        awayTeam: "Argentina",
    ...
    loginNav = $('#login-nav');
    main = $('#main');
    showGames = function(title, gamess) {
    ...
    showUpcomingGames = function() {
      return showGames("Upcoming games:", upcomingGames);
    };
    showPastGames = function() {
      return showGames("Past games:", pastGames);
    };
